...
app.state.config.AUTO_BYPASS_FILE_EMBEDDING_SIZE_THRESHOLD = AUTO_BYPASS_FILE_EMBEDDING_SIZE_THRESHOLD
...
app.state.config.AUTO_BYPASS_WEB_SEARCH_EMBEDDING_SIZE_THRESHOLD = (
    AUTO_BYPASS_WEB_SEARCH_EMBEDDING_SIZE_THRESHOLD
)
